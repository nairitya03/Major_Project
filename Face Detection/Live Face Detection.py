...
# ASCII Text Art
print(pyfiglet.figlet_format("Live Face Detection", font = "bulbhead" ))
...
if (faceCascade.empty() or eyeCascade.empty()):
    print("Cascade File not Found... Please Check and Try again")
    exit()
    ...
    try:
        ...
        while True:
            ...
            for (x, y, w, h) in faceCascade.detectMultiScale(gray,1.3,4):
                ...
                #Top Left x,y    
                cv2.line(frame, (x, y), (x+30, y), (255, 0, 255), 5)
                cv2.line(frame, (x, y), (x, y+30), (255, 0, 255), 5)

                #Top right x1,y
                cv2.line(frame, (x1, y), (x1-30, y ), (255, 0, 255), 5)
                cv2.line(frame, (x1, y), (x1, y+30), (255, 0, 255), 5)

                #Bottom Left x,y1
                cv2.line(frame, (x, y1), (x+30, y1), (255, 0, 255), 5)
                cv2.line(frame, (x, y1), (x, y1-30), (255, 0, 255), 5)

                #Bottom Right x1,y1
                cv2.line(frame, (x1, y1), (x1-30, y1), (255, 0, 255), 5)
                cv2.line(frame, (x1, y1), (x1, y1-30), (255, 0, 255), 5)
        ...
        print("WebCam Not Found!! Check and Try again...")
...
def static():
    ...
    for (x,y,w,h) in faceCascade.detectMultiScale(gray,1.3,4):
        cv2.rectangle(img_scale, (x,y), (x+w, y+h), (0, 255, 0), 2)

    # Result Displaying !!
    cv2.imshow("Faces found", img_scale)    
    print("The number of faces found = ", len(faceCascade.detectMultiScale(gray,1.2,4)))
